...
-- Command     : write_vhdl -force -mode funcsim -rename_top BlockDesign_Clock_divider_2_0 -prefix
--               BlockDesign_Clock_divider_2_0_ main_design_Clock_divider_1_0_sim_netlist.vhdl
...
entity BlockDesign_Clock_divider_2_0_Clock_divider is
  port (
    CLK_OUT : out STD_LOGIC;
    CLK_IN : in STD_LOGIC
  );
end BlockDesign_Clock_divider_2_0_Clock_divider;

architecture STRUCTURE of BlockDesign_Clock_divider_2_0_Clock_divider is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity BlockDesign_Clock_divider_2_0 is
  port (
    CLK_IN : in STD_LOGIC;
    CLK_OUT : out STD_LOGIC
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of BlockDesign_Clock_divider_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of BlockDesign_Clock_divider_2_0 : entity is "main_design_Clock_divider_1_0,Clock_divider,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of BlockDesign_Clock_divider_2_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of BlockDesign_Clock_divider_2_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of BlockDesign_Clock_divider_2_0 : entity is "Clock_divider,Vivado 2022.1";
end BlockDesign_Clock_divider_2_0;

architecture STRUCTURE of BlockDesign_Clock_divider_2_0 is
begin
inst: entity work.BlockDesign_Clock_divider_2_0_Clock_divider
     port map (
      CLK_IN => CLK_IN,
      CLK_OUT => CLK_OUT
    );
